<?php
	...
	switch($datoPregunta['tipoObjeto']){
		case 'Imagen':
			echo '<img style = "height: cover; width: 300px" src="/sabiogc/uploads/'.$datoPregunta['Objeto'].'">';
			echo "<br/><br/>";
			break;
		case 'Vídeo':
			echo '<video width="300" height="cover" controls><source src="/sabiogc/uploads/'.$datoPregunta['Objeto'].'"></video>';
			echo "<br/><br/>";
			break;
		case 'Audio':
			echo '<audio controls><source src="/sabiogc/uploads/'.$datoPregunta['Objeto'].'"></audio>';
			echo "<br/><br/>";
			break;
	}
